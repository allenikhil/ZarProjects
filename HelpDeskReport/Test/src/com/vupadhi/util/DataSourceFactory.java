...
public class DataSourceFactory {
	...
	public static String getDriverClassName() {
		...
		filepath = getExtPropertyObj().getProperty("jdbc.driverClassName");
		return filepath;
	}
	public static String getDriverURL() {
		String filepath = null;
		filepath = getExtPropertyObj().getProperty("jdbc.url");
		return filepath;
	}
	public static String getJDBCUserName() {
		String filepath = null;
		filepath = getExtPropertyObj().getProperty("jdbc.username");
		return filepath;
	}
	
	public static String getJDBCPassWord() {
		String filepath = null;
		filepath = getExtPropertyObj().getProperty("jdbc.password");
		return filepath;
	}

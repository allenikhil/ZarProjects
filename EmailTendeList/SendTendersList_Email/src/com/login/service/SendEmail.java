...
public class SendEmail {
	...
	private static final String EMAIL_FROM = "helpdesk.eproc@telangana.gov.in";
	...
	private static final String EMAIL_TO = "suryateja.n@vupadhi.com,pavankumar.t@vupadhi.com,udayabhaskar@vupadhi.com,ashokkumar.p@vupadhi.com,tssupport.mngr@vupadhi.com,ravindranathguptha.p@vupadhi.com";
	private static final String EMAIL_SUBJECT = "Relevant tenders for business opportunity in Telangana";
	...
	public static void main(String[] args) {
		...
		session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("helpdesk.eproc@telangana.gov.in", "H@e$2017");
			}
		});
		try {
			sendEmail();
	...
	public static void sendEmail() throws SQLException, ClassNotFoundException, ParseException {
		Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
		  ...
		  String  userName = "eprocuser";
		    String password = "#vPEhQxk$+x4LJ%=FgFG";
		    String url = "jdbc:sqlserver://10.10.6.30;databaseName=TSTMS";
	...
	//	System.out.println(list.size());
		...
		try {
			...
			sb.append(
					"<h3 align='center'><FONT face='Arial'> <strong><u>RELEVANT TENDERS FOR BUSINESS OPPORTUNITY IN TELANGANA </u></strong></FONT></h3><br/>");
			...
			sb.append("</FONT>");
			sb.append("</table>");
			sb.append("* Queried based on keywords only");
			sb.append("<br/><br/>");
